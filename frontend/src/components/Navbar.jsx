...
export default function Navbar({ onMenuClick }) {
  ...
  const pageTitle = ROUTE_LABELS[location.pathname]
    || (location.pathname.startsWith('/analysis') ? 'Neural Analysis' : 'LexiSure AI');
  ...
  return (
    <header style={{
      ...
      <button
        onClick={onMenuClick}
        style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid var(--border)', cursor: 'pointer', color: 'var(--text-secondary)', width: 40, height: 40, borderRadius: 10, display: 'flex', alignItems: 'center', justifyContent: 'center' }}
      >
        <Menu size={20} />
      </button>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div style={{ width: 1, height: 20, background: 'var(--border)' }} className="mobile-hide" />
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        >
          <Bell size={18} />
          <span style={{ position: 'absolute', top: 10, right: 10, width: 6, height: 6, background: '#ef4444', borderRadius: '50%', border: '1.5px solid #0a0b0e' }} />
        </NavLink>

        <div style={{ width: 1, height: 24, background: 'var(--border)', margin: '0 4px' }} className="mobile-hide" />
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                 ...
                 <button
                   ...
                   style={{
                     ...
                     padding: '8px 12px', background: 'rgba(239,68,68,0.05)', border: 'none',
